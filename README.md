...
| Database managing website| A webpage where you can add, retrieve and modify data from a database|This uses Java, HTML and CSS as well as Supabase to host the database |[Database Website](https://github.com/TosinCZ/Backend-CW) |
